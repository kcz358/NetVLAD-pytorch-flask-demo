...
class PCA():
    ...
    def train(self, x, gpu):
        ...
        if self.save:
            filename = self.pca_parameters_path
        ...
        U = U[:, :self.pca_n_components]
        lams = lams[:self.pca_n_components]
